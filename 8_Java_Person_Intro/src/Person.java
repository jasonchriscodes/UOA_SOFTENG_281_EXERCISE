...
public class Person { // define custom type (person class)
	...
	// Note/ if the constructor does not match the instance input, it will complain
	// (order, number of input)
	...
	// public Person(String fn = firstName, String lastName, int 10) { we CANNOT
	// initialised variable in parenthese in java
	// }
